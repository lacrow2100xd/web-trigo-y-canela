    ...
    <div class="row justify-content-center">
        <div class="col-md-3">
            <div class="card shadow-sm"> 
                ...
                <img src="Img/Diseño sin título (2).png" alt="Imagen 1">
                <div class="card-body">
                    <h5 class="card-title mt-2">Ingredientes naturales</h5>
                    <p class="card-text">Sin saborizantes ni colorantes artificiales. Seleccionamos con rigor todas las materias primas y utilizamos productos de origen local o de proximidad.</p>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">En nuestro obrador cuidamos al máximo cada paso en la elaboración de nuestro pan.</p>
                    <button class="toggle-button btn btn-light no-hover">Saber más 
                      <i class="fa-solid fa-chevron-down" id="chevron-down" style="display: inline-block;"></i>
                      <i class="fa-solid fa-chevron-up" id="chevron-up" style="display: none;"></i>
                    </button>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">100% artesanal, de larga fermentación.</p>
                    <button class="toggle-button btn btn-light no-hover">Saber más 
                      <i class="fa-solid fa-chevron-down" id="chevron-down" style="display: inline-block;"></i>
                      <i class="fa-solid fa-chevron-up" id="chevron-up" style="display: none;"></i>
                    </button>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Todo esto garantiza una inmejorable textura y completa homogeneidad en el pan, que refleja la calidad de Trigo y canela, para hacer un PAN ÚNICO.</p>
                    <button class="toggle-button btn btn-light no-hover">Saber más 
                      <i class="fa-solid fa-chevron-down" id="chevron-down" style="display: inline-block;"></i>
                      <i class="fa-solid fa-chevron-up" id="chevron-up" style="display: none;"></i>
                    </button>
