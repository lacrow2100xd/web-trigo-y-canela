...
$sql = $con->prepare("SELECT id, nombre, descripcion, imagen, precio, stock, descuento, id_categoria FROM productos WHERE id = ? AND activo = 1");
$sql->execute([$id]);
    ...
    <div class="title-wrapper pt-30">
                    ...
                    <div class="breadcrumb-wrapper">
                      <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item"><a href="<?php echo ADMIN_URL; ?>productos">Productos</a></li>
      ...
      <div class="card-style">
          ...
          <form action="actualiza.php" method="post" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="col-4 mb-3">
                  ...
                  htmlspecialchars($producto['nombre'], ENT_QUOTES);?>" required autofocus/>
              </div>
              <div class="mb-3">
                  <label for="descripcion" class="form-label mt-2">Descripcion</label>
                  <textarea class="form-control" name="descripcion" id="editor" ><?php echo 
     ...
     <div class="col-4">
        <div class="position-relative">
            <?php if (isset($producto['imagen']) && file_exists($rutaImagenes . $producto['imagen'])): ?>
                <img src="<?php echo $rutaImagenes . $producto['imagen']. '?id' . time(); ?>" class="img-fluid img-thumbnail my-3 rounded" style="padding: 0px";><br>

                <!-- Botón en la esquina superior derecha de la imagen -->
                <button
                    type="button"
                    class="text-white btn btn-danger position-absolute"
                    style="top: 30px; right: 10px; padding: 5px 10px; border: none; background-color: rgba(255, 0, 0, 0.8);"
            ...
            <?php endif; ?>
              ...
              <div class="row">
                  ...
                  <div class="col mb-3">
                      ...
                      <input type="number" class="form-control" name="descuento" id="descuento" value="<?php echo 
                  $producto['descuento'];?>" required />
                  </div>
                  <div class="col mb-3">
                      <label for="stock" class="form-label mt-2">Stock</label>
                      <input type="number" class="form-control" name="stock" id="stock" value="<?php echo 
        ...
        >
            ...
            >
                <div class="modal-content">
                    ...
                    <div class="modal-body">¿Desea eliminar la imagen del producto?</div>
                    <div class="modal-footer">
                        <form action="eliminaImagen.php" method="post">
